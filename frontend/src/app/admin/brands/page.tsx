...
import { Plus, Pencil, Trash2, Tag, Check, X, Image as ImageIcon, Search } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(err.message || "Failed to save brand data.");
      }
    } catch (err) { 
      console.error("Brand Save Error:", err);
      alert("Network error occurred while saving brand."); 
    } finally { 
      setSaving(false); 
    }
  };
